...
<body bgcolor="white" text = "Arial">
	...
	<form method="POST" action="loginpro.php" style=" padding-top:70px;padding-bottom:70px;padding-left:100px;padding-right:100px;">
	...
	<h1 align="center">Admin Login</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>Enter User Name :</font></h2></td>
