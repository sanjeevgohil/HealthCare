<?php
	...
	$id = $_POST['id'];
	$q = mysqli_query($cn,"select * from patient where id='$id'");
...
<body bgcolor="white" text = "Arial">
	...
	<form method="POST" action="patientupd2.php" style=" padding-top:70px;padding-bottom:70px;padding-left:100px;padding-right:100px;" enctype="multipart/form-data">
	...
	<h1 align="center">Patients Registration</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>Contact Number :</font></h2></td>
				<td> <input type="text" name="cno" value="<?php echo $r[4]; ?>"></td>
		</tr><tr></tr><tr></tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>Email :</font></h2></td>
				<td> <input type="text" name="email" value="<?php echo $r[5]; ?>"></td>
		</tr><tr></tr><tr></tr>
		...
		<tr style="width:100%">
				...
				<td> <input type="file" name="photo" value="<?php echo $r[7]; ?>"></td>				
		</tr><tr></tr><tr></tr>
...
<?php
	...
	echo "<tr><td>Id</td><td>Name</td><td>Username</td><td>Password</td><td>Contact Number</td><td>email</td><td>City</td><td>Photo</td>";
	while($r = mysqli_fetch_array($q))
	{
		echo "<tr><td>".$r[0]."</td><td>".$r[1]."</td><td>".$r[2]."</td><td>".$r[3]."</td><td>".$r[4]."</td><td>".$r[5]."</td><td>".$r[6]."</td><td><img src='../upload/".$r[7]."' width='150px' height='150px'></td></tr>";
	}
	echo "</table>";
