...
<body bgcolor="white" text = "Arial">
	...
	<form method="POST" action="pupdate2.php" style=" padding-top:70px;padding-bottom:70px;padding-left:100px;padding-right:100px;" enctype="multipart/form-data">
	...
	<h1 align="center">Patients Details Update</h1>
		 		<br>
		...
		<tr style="width:100%">
				...
				<td> <input type="text" name="mno" value="<?php echo $r[4]; ?>"></td>
		</tr><tr></tr><tr></tr>
