...
<body bgcolor="white" text = "Arial">
	...
	<form method="POST" action="faqpro.php" style=" padding-top:70px;padding-bottom:70px;padding-left:100px;padding-right:100px;">
	...
	<h1 align="center">FAQ Form</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>ASK Question :</font></h2></td>
				<td style="width:50%" align="left"><input type="text" name="que" placeholder="Enter Question Number Hear" required size=30></td>
		</tr><tr></tr><tr></tr>
