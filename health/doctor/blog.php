...
<body bgcolor="white" text = "Arial">
	...
	<form method="POST" action="blogpro.php" style=" padding-top:70px;padding-bottom:70px;padding-left:100px;padding-right:100px;" enctype="multipart/form-data">
	...
	<h1 align="center">Blog</h1>
		...
		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>Blog :</font></h2></td>
				<td style="width:50%" align="left"><input type="text" name="blog" placeholder="Type Blog" required size=30></td>
		</tr><tr></tr><tr></tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>Select Blog Image  :</font></h2></td>
